...
const Course2LessonsPage = () => {
    ...
    const fetchLessons = async () => {
      try {
        ...
        const filtered = res.data
          .filter(lesson => lesson.courseCode === 2)
  ...
  return (
    <div className="course-container">
      <h2 >📘 English Course — All Lessons</h2>
      {error && <p >{error}</p>}
        ...
        return (
          <div key={lesson._id} className="lesson-card">
            ...
            <table >
              ...
              <Link className="quiz-btn" to={`/courses/2/lessons/${lesson.lessonId}/quiz`}>
                Take Quiz
              </Link>
...
export default Course2LessonsPage;
